      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-5">
               <hr> 
                <form action="{{route('edit_post', $info->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row shadow">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="Text" class="form-control" name="F_Name" value={{$info->F_name}} aria-describedby="emailHelp" placeholder="Enter First Name">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="Text" class="form-control" name="L_Name" value={{$info->L_name}} id="" aria-describedby="emailHelp" placeholder="Enter Last Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="Text" class="form-control" value= {{$info->Phone}} id="" aria-describedby="emailHelp" name="P_number" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
