      ...
      <div class="container">
        ...
        <hr>
            ...
            <h3>Deduct Balance</h3>
                ...
                <hr> 
                <form action="{{ route('provider-update-deduct-wallet') }}" method="POST" >
                    @csrf
                        <div class="row">
                            <div class="col-md-8">
                                <h5>Entered Amount Will Be Deducted Directly To Provider's Account.</h5><br>
                                ...
                                <button type="submit" class=" btn btn-primary shadow">Deduct</button>
