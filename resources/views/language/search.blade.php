                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table" >
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control mr-sm-2">
                                                <option value="">All</option>
                                                <option value="vLabel"  >Code</option>
                                                <option value="vValue"  >Value In عربى Language</option>
                                            </select>
                                        </td>
                                        ...
                                        <td width="30%">
                                     <a class="btn btn-warning" href="{{ route('addLang') }}" style="text-align: center;">Add Label</a>
                            ...
                            <div class="table-responsive">
                                <form class="_list_form" id="_list_form" method="post" action="/admin/languages.php">
                                    <table class="table table-striped table-bordered table-hover dd-tt">
                                        <thead>
                                            <tr>
                                                <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,0)">Code <i class="fa fa-sort" aria-hidden="true"></i> </a></th>
                                                <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,0)">Value In عربى Language <i class="fa fa-sort" aria-hidden="true"></i> </a></th>
