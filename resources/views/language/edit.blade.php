                            ...
                            <div style="clear:both;"></div>
                                <form method="post" action="{{ route('update',$data->id) }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="label"   value="{{ $data->code }}" placeholder="Please Enter to this formate => LBL_" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="value_en" id="value_en" value="{{ $data->value_en }}" placeholder="English Value" >
                                            </div>
                                    </div>                                                                                                                  
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="value_ar" id="value_ar" value="{{ $data->value_ar }}" placeholder="عربى Value" required>
                                        </div>
                                    <div class="col-lg-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <input type="submit" class="btn btn-default" name="submit" id="submit" value="Edit Label">
